...
export default function BodyRegionPin({ region, isActive, onClick }) {
  ...
  return (
    ...
    >
      {/* Sleek Dot Core */}
      <div className="body-pin__core">
        <span className="body-pin__pulse" />
        <span className="body-pin__center-dot" />
      </div>

      {/* Glass Tooltip - visible on hover or active */}
      <div className="body-pin__tooltip glass-card">
