...
function [Data_Test_SVM,Labels_Test_SVM ] = SVM_Data(Data_Train_SVM, Labels_Train_SVM, filepath1_Test_Empty, numpackets, filepath2_Test_SIT, filepath3_Test_STAND, filepath4_Test_WALK )
%% TESTING
% tic
