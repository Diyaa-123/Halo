...
class MultiPersonTracker:
    def __init__(self, max_occupants: int = 3):
        ...
        self._SPAWN_GATE_FRAMES = 3  # require 3 consecutive frames before spawning
    ...
    def update_tracking(self, estimated_positions: List[Tuple[float, float, float]], extracted_vitals: List[Tuple[float, float]]) -> List[Dict]:
        """
        ...
        Z_CEILING = 2.13  # meters — 7 feet ceiling (ITU-R residential assumption)
